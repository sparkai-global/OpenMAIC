...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    ...
    // const PARENT_APP_BASE = 'http://192.168.2.79:8081';  // 父项目后端：测试 8.156.87.115:8081 / 正式 8.137.101.85:8081
    const PARENT_APP_BASE = 'http://8.137.101.85:8081';  // 父项目后端：测试 8.156.87.115:8081 / 正式 8.137.101.85:8081
